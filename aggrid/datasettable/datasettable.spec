{
	...
	"model":
	{
		...
		"rowStyleClassFunc": { "type": "clientfunction", "tags": {"doc": "Function to add style class to row. Parameters: rowIndex, rowData, event, isGroup, params (AG Grid RowClassParams — includes node, api, context)"}},
	...
	"types" : {
		"column" : {
			...
			"dataprovider": { "type": "string", "tags": { "basic": true }},
			"tooltip": { "type": "string"},
			...
			"id": {"type" : "string", "tags": {"basic" : true, "wizard": {"prefill" : "dataprovider", "unique": true}, "showInOutlineView": true, "doc": "Used to set the column id (colId) property in the serialized column state json string of getColumnState and onColumnStateChanged" }},
			...
			"valuelist": { "type": "valuelist", "config": "valuelistConfig", "tags": { "basic": true }},
