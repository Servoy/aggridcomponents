				...
				function getFormEditor() {
					...
					FormEditor.prototype.init = function(params) {
						...
						this.eGui.innerHTML = '<div id="nggridformeditor" svyform="' + column.editForm +
							'" ng-include="getNGEditFormUrl()" style="width:' + ((column.editFormSize && column.editFormSize.width) ? column.editFormSize.width : 300) + 'px; height:' + ((column.editFormSize && column.editFormSize.height) ? column.editFormSize.height : 200) + 'px;"></div>';
