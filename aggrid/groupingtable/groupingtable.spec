{
	...
	"handlers" : {
		...
		"onDrop": {
			...
			"parameters": [{
				"name": "sourceRows",
				"type": "object[]",
				"doc": "an Array of JSRecord objects if dragged from a data grid, or plain objects if from a power grid"
			}, {
				"name": "targetRecord",
				"type": "record"
			}, {
	...
	"types" : {
		"column" : {
			...
			"format" : {"type" : "format",  "for": ["valuelist", "dataprovider"], "tags": { "basic": true }},
			"valuelist": { "type": "valuelist", "for": "dataprovider", "forFoundset": "myFoundset", "config": "valuelistConfig","tags": { "basic": true }},
